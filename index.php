...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="statics/apple-touch-icon.png.url">
...
<body style="background-image:url('statics/5570834-min.jpg'); padding-top:1%;">
        ...
        <div class="row">
            <div class="col" style="margin-left: 5%;">
                <br><br>&nbsp;<p class="zoomfont"
                    style="font-size:0px; text-shadow:3px 3px 3px grey; text-align:center;"><b><i>Welcome to Sparks Bank!</i></b></p>
            </div>
        ...
        <div class="container"
            ...
            <div class="container" style="margin:30px 0px 20px 0px;">
                <div class="row">
                    <div class="col-lg">
                        <div
                            style="background-color:#343a40; color:black; width: 90%; border-radius:30px; box-shadow:3px 3px 8px gray; padding:20px 10px 20px 10px;">
                            ...
                            <h6 style="color:white;">Here, you can watch every customer of the bank.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="send_money.php"><button type="button" class="btn btn-outline-light mybtn">Transfer
                                    Money</button></a><br>
                            <h6 style="color:white;">Here, you can send money from your account.</h6>
                        </div>
                    </div>
                    <div class="col-lg">
                        <div
                            ...
                            <a href="check_blc.php"><button type="button" class="btn btn-outline-light mybtn">Check
                                    Balance</button></a><br>
                            <h6 style="color:white;">Here, you can check the remaining balance in your account.</h6>
                        </div>
                    </div>
                </div>
            </div>
